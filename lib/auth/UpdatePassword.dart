...
class UpdastePassword extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _UpdastePassword();
  }

}

class _UpdastePassword extends State<UpdastePassword> {
  ...
  Future<void> resetPassword() async {
    ...
    if (_passwordController.text == '') {
      ...
      var response = await http.put(Common.BASE_URL+"user/updatepassword",
          body: {"password": _passwordController.text}, headers: headers);
      ...
      if (response.statusCode == 200) {
        ...
        Fluttertoast.showToast(msg: loginErrorResponse.message);
